...
public class Solo {
	...
	public static class Config {
		...
		/**
		 * The timeout length of the get, is, set, assert, enter and click
		 * methods. Default length is 10 000 milliseconds.
		 */
		public int timeout_small = 10000;

		/**
		 * The timeout length of the waitFor methods. Default length is 20 000
		 * milliseconds.
		 */
	...
	public void clickLongOnTextAndPress(String text, int index) {
		if (config.commandLogging) {
			Log.d(config.commandLoggingTag, "clickLongOnTextAndPress(\"" + text
					+ "\", " + index + ")");
		}
	 ...
	 *
	 * @param index
	 *            the index of the {@link Button} to click. {@code 0} if only
	 *            one is available
	 */
	 ...
	 *
	 * @param index
	 *            the index of the {@link RadioButton} to click. {@code 0} if
	 ...
	 *
	 * @param index
	 *            the index of the {@link CheckBox} to click. {@code 0} if only
	 *            one is available
	 */
	 ...
	 *
	 * @param index
	 *            the index of the {@link EditText} to click. {@code 0} if only
	 *            one is available
	 */
	...
	/**
	 * Clicks the specified list line and returns an ArrayList of the TextView
	 * objects that the list line is displaying. Will use the first ListView it
	 * finds.
	 *
	 * @param line
	 *            the line to click
	...
	/**
	 * Clicks the specified list line in the ListView matching the specified
	 * index and returns an ArrayList of the TextView objects that the list line
	 * is displaying.
	 *
	 * @param line
	 *            the line to click
	 * @param index
	 *            the index of the list. {@code 0} if only one is available
	 * @return an {@code ArrayList} of the {@link TextView} objects located in
	 *         the list line
	 */
	...
	/**
	 * Clicks a View with a specified resource id on the specified line in the
	 * list matching the specified index
	 *
	...
	/**
	 * Long clicks the specified list line and returns an ArrayList of the
	 * TextView objects that the list line is displaying. Will use the first
	 * ListView it finds.
	 *
	 * @param line
	 *            the line to click
	...
	/**
	 * Clicks the specified item index and returns an ArrayList of the TextView
	 * objects that the item index is displaying. Will use the first
	 * RecyclerView it finds.
	 *
	 * @param itemIndex
	 *            the item index to click
	 * @return an {@code ArrayList} of the {@link TextView} objects located in
	 *         the item index
	 */
	...
	/**
	 * Clicks a View with a specified resource id on the specified item index in
	 * the RecyclerView matching the specified RecyclerView index
	 *
	...
	/**
	 * Long clicks the specified item index and returns an ArrayList of the
	 * TextView objects that the item index is displaying. Will use the first
	 * RecyclerView it finds.
	 *
	 * @param itemIndex
	 *            the item index to click
	...
	/**
	 * Simulate drawing an illustration on the screen. <br>
	 * <br>
	 * Example of usage:
	 * 
	 * <pre>
	 ...
	 *
	 * @return {@code true} if more scrolling can be performed and {@code false}
	 ...
	 *
	 * @param index
	 *            the index of the {@link ListView} to scroll. {@code 0} if only
	 *            one list is available
	 * @return {@code true} if more scrolling can be performed
	 */
	...
	public boolean scrollListToTop(AbsListView listView,int index) {
		if (config.commandLogging) {
			Log.d(config.commandLoggingTag, "scrollListToTop(" + index + ")");
		}
	...
	public void scrollListToLine(AbsListView absListView, int line) {
		if (config.commandLogging) {
			Log.d(config.commandLoggingTag, "scrollListToLine(" + absListView
					+ ", " + line + ")");
		}
	 ...
	 *
	 * @param index
	 *            the index of the {@link AbsListView} to scroll
	 * @param line
	...
	public void scrollListToLine(int index, int line) {
		if (config.commandLogging) {
			Log.d(config.commandLoggingTag, "scrollListToLine(" + index + ", "
					+ line + ")");
		}
	 ...
	 *
	 * @param index
	 *            the index of the RecyclerView to scroll. {@code 0} if only one
	 *            RecyclerView is available
	 * @return {@code true} if more scrolling can be performed
	 */
	...
	public boolean scrollRecyclerViewToBottom(int index) {
		if (config.commandLogging) {
			Log.d(config.commandLoggingTag, "scrollRecyclerViewToBottom("
					+ index + ")");
		}
	...
	public void scrollToSide(int side, float scrollPosition, int stepCount) {
		...
		case RIGHT:
			...
			break;
		case LEFT:
			scroller.scrollToSide(Scroller.Side.LEFT, scrollPosition, stepCount);
			break;
		}
	}
	...
	/**
	 * Swipes with two fingers in a linear path determined by starting and
	 * ending points. Requires API level >= 14.
	 *
	 * @param startPoint1 First "finger" down on the screen
	 * @param startPoint2 Second "finger" down on the screen
	 * @param endPoint1 Corresponding ending point of startPoint1
	...
	public void rotateLarge(PointF center1, PointF center2) {
		if (config.commandLogging) {
			Log.d(config.commandLoggingTag, "rotateLarge(" + center1 + ", "
					+ center2 + ")");
		}
	...
	/**
	 * Draws two semi-circles at the specified centers. Both circles are smaller
	 * than rotateLarge(). Requires API level >= 14.
	 *
	 * @param center1
	...
	public void rotateSmall(PointF center1, PointF center2) {
		if (config.commandLogging) {
			Log.d(config.commandLoggingTag, "rotateSmall(" + center1 + ", "
					+ center2 + ")");
		}
	...
	/**
	 * Sets the progress of a ProgressBar matching the specified index. Examples
	 * of ProgressBars are: {@link android.widget.SeekBar} and
	 * {@link android.widget.RatingBar}.
	 *
	 * @param index
	 *            the index of the {@link ProgressBar}
	 * @param progress
	 *            the progress to set the {@link ProgressBar}
	 */

	public void setProgressBar(int index, int progress) {
		if (config.commandLogging) {
			Log.d(config.commandLoggingTag, "setProgressBar(" + index + ", "
					+ progress + ")");
		}
	...
	public void setSlidingDrawer(int index, int status) {
		if (config.commandLogging) {
			Log.d(config.commandLoggingTag, "setSlidingDrawer(" + index + ", "
					+ status + ")");
		}
	...
	public void setSlidingDrawer(SlidingDrawer slidingDrawer, int status) {
		if (config.commandLogging) {
			Log.d(config.commandLoggingTag, "setSlidingDrawer(" + slidingDrawer
					+ ", " + status + ")");
		}
	 ...
	 *            available
	 * @param text
	 *            the text to enter in the {@link EditText} field
	 */

	public void enterText(int index, String text) {
		if (config.commandLogging) {
			Log.d(config.commandLoggingTag, "enterText(" + index + ", \""
					+ text + "\")");
		}

		textEnterer.setEditText(
				waiter.waitForAndGetView(index, EditText.class), text);
	}
	 ...
	 *
	 * @param editText
	 *            the {@link EditText} to enter text in
	 * @param text
	 *            the text to enter in the {@link EditText} field
	 */
	...
	public void enterText(EditText editText, String text) {
		if (config.commandLogging) {
			Log.d(config.commandLoggingTag, "enterText(" + editText + ", \""
					+ text + "\")");
		}
	 ...
	 *
	 * @param by
	 *            the By object. Examples are: {@code By.id("id")} and
	 *            {@code By.name("name")}
	 * @param text
	 *            the text to enter in the {@link WebElement} field
	 */

	public void enterTextInWebElement(By by, String text) {
		if (config.commandLogging) {
			Log.d(config.commandLoggingTag, "enterTextInWebElement(" + by
					+ ", \"" + text + "\")");
		}

		if (waiter.waitForWebElement(by, 0, Timeout.getSmallTimeout(), true) == null) {
			Assert.fail("WebElement with "
					+ webUtils.splitNameByUpperCase(by.getClass()
							.getSimpleName()) + ": '" + by.getValue()
					+ "' is not found!");
		}
	 ...
	 * @param text
	 *            the text to type in the {@link EditText} field
	 */
	...
	public void typeTextInWebElement(WebElement webElement, String text) {
		if (config.commandLogging) {
			Log.d(config.commandLoggingTag, "typeTextInWebElement("
					+ webElement + ", \"" + text + "\")");
		}
	 ...
	 *
	 * @param index
	 *            the index of the {@link EditText} to clear. 0 if only one is
	 *            available
	 */
	...
	public void clearEditText(int index) {
		...
		textEnterer.setEditText(
				waiter.waitForAndGetView(index, EditText.class), "");
	}
	 ...
	 *
	 * @param index
	 *            the index of the {@link ImageView} to click. {@code 0} if only
	 *            one is available
	 */
	 ...
	 *            the text that is displayed, specified as a regular expression
	 * @param onlyVisible
	 *            {@code true} if only visible texts on the screen should be
	 *            returned
	 * @return the {@link TextView} displaying the specified text
	 */
	 ...
	 *            the text that is displayed, specified as a regular expression
	 * @param onlyVisible
	 *            {@code true} if only visible buttons on the screen should be
	 *            returned
	 * @return the {@link Button} displaying the specified text
	 */
	 ...
	 *            the text that is displayed, specified as a regular expression
	 * @param onlyVisible
	 *            {@code true} if only visible EditTexts on the screen should be
	 *            returned
	 * @return the {@link EditText} displaying the specified text
	 */
	 ...
	 *
	 * @param id
	 *            the R.id of the {@link View} to return
	...
	public View getView(int id, int index) {
		...
		if (viewToReturn == null) {
			String resourceName = "";
			try {
				resourceName = instrumentation.getTargetContext()
			...
			int match = index + 1;
			if (match > 1) {
				Assert.fail(match + " Views with id: '" + id
	 ...
	 *
	 * @param tag
	 *            the tag of the {@link View} to return
	 * @return a {@link View} matching the specified id
	 */
	...
	public View getView(Object tag, int index) {
		...
		if (viewToReturn == null) {
			int match = index + 1;
			if (match > 1) {
				Assert.fail(match + " Views with id: '" + tag
						+ "' are not found!");
			} else {
	...
	public <T extends View> T getView(Class<T> viewClass, int index) {
		if (config.commandLogging) {
			Log.d(config.commandLoggingTag, "getView(" + viewClass + ", "
					+ index + ")");
		}
	...
	public WebElement getWebElement(By by, int index) {
		if (config.commandLogging) {
			Log.d(config.commandLoggingTag, "getWebElement(" + by + ", "
					+ index + ")");
		}
	...
	/**
	 * Returns an ArrayList of the Views currently displayed in the focused
	 * Activity or Dialog.
	 *
	 * @return an {@code ArrayList} of the {@link View} objects currently
	 *         displayed in the focused window
	 */
	...
	/**
	 * Returns an ArrayList of Views matching the specified class located in the
	 * focused Activity or Dialog.
	 *
	 * @param classToFilterBy
	 *            return all instances of this class. Examples are:
	 *            {@code Button.class} or {@code ListView.class}
	 * @return an {@code ArrayList} of {@code View}s matching the specified
	...
	public <T extends View> ArrayList<T> getCurrentViews(
		...
		if (config.commandLogging) {
			Log.d(config.commandLoggingTag, "getCurrentViews("
					+ classToFilterBy + ", " + includeSubclasses + ")");
		}
	...
	/**
	 * Returns an ArrayList of Views matching the specified class located under
	...
	/**
	 * Returns an ArrayList of all the WebElements displayed in the active
	 * WebView.
	 *
	 * @return an {@code ArrayList} of all the {@link WebElement} objects
	 *         currently displayed in the active WebView
	 */
	...
	/**
	 * Returns an ArrayList of the currently displayed WebElements in the active
	 * WebView.
	 *
	 * @return an {@code ArrayList} of the {@link WebElement} objects displayed
	...
	public boolean waitForEmptyActivityStack(int timeout) {
		if (config.commandLogging) {
			Log.d(config.commandLoggingTag, "waitForEmptyActivityStack("
					+ timeout + ")");
		}
	...
	/**
	 * 返回目标应用的上下文，例如当前测试的是微博，那么返回的就是微博应用的上下文
	 * @return
     */
...
//		return getter.getView(viewClass,index);
//	}
